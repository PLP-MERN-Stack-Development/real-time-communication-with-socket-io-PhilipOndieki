// src/components/chat/Sidebar.jsx - iOS-inspired minimalist sidebar with divider button
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className={`${activeConversation ? 'hidden md:flex' : 'flex'} w-full md:w-96 bg-white flex-col h-screen ios-rounded-lg md:rounded-none overflow-hidden relative`}>
        {/* Header */}
      ...
      <div className="hidden md:block w-px bg-gray-200 h-screen flex-shrink-0" />
